...
| --- | --- | ---: | ---: |
| Windows Security Auditing | `Microsoft-Windows-Security-Auditing / Security / Windows Server 2025 Datacenter 24H2 build 26100.33296` — 423 unique Event IDs / 488 provider event-version definitions | `3/423` — Event IDs `4624`, `4625`, `4688` | 420 |
