...
- Phase 5.10.10 — Windows & Sysmon Knowledge Coverage Expansion: **ACTIVE / IMPLEMENTATION IN PROGRESS**
  - machine-readable family authority: `content/encyclopedia/coverage-manifest.json` (`global_windows_denominator_frozen=false`)
  - current Phase 5.10.10 candidate builder: `303` canonical records = `102` entities + `106` claims + `88` relationships + `7` sources
  - search projections: `16`; graph edges: `3`; encyclopedia-grade exemplar count: `4`
  ...
  - pinned Sysmon semantic documentation: `15.22`; documented/current denominator: `30` IDs (`1..29`, `255`)
  - controlled Sysmon 15.22 / schema 4.91 telemetry baseline: **VALIDATED / OPERATOR REVIEWED / PROMOTED**
  - reference evidence: workflow run `35413291632`; `24` schema manifests; `587` parsed records; `30` current Event IDs; no structural drift observed from the prior promoted baseline
  - remaining Sysmon encyclopedia-grade work: **28 Event IDs** (`2/30`, `6.67%` complete for the frozen Sysmon 15.22 denominator)
  - Security-Auditing controlled denominator: **FROZEN FOR Microsoft-Windows-Security-Auditing / Security / Windows Server 2025 build 26100.33296 — 423 unique Event IDs**; `4624` and `4688` encyclopedia-grade (`2/423`, `0.47%` for this exact scope); global all-Windows denominator: **NOT FROZEN**
