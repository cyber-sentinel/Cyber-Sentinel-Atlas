...
- Controlled telemetry-schema evidence is now Sysmon `15.22` / schema `4.91`, validated on the controlled reference host, operator-reviewed, and promoted by PR #81; the prior 15.21 inventory remains preserved as historical evidence, while documentation and schema freshness continue to be tracked independently.
