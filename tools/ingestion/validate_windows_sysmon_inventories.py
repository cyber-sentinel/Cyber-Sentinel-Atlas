...
INVENTORY_PATHS = {
    ...
    "sysmon_docs": ROOT / "ingestion/inventories/sysmon-docs-15.21.documentation.json",
}
...
def reconcile(inventories: dict[str, dict]) -> dict:
    ...
    if sysmon_docs != sysmon_schema:
        errors.append("Sysmon 15.21 documentation and current schema 4.91 identity sets drifted")
